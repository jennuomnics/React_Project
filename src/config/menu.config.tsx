import { AlertCircle, Award, Badge, Bell, Bitcoin, Bolt, Book, Briefcase, Building, CalendarCheck, Captions, CheckCircle, Code, Codepen, Coffee, File as DocumentIcon, Euro, Eye, File, FileQuestion, FileText, Flag, Ghost, Gift, Grid, Heart, HelpCircle, Kanban, Key, Layout, LayoutGrid, LifeBuoy, MessageSquare, Monitor, Network, Users as PeopleIcon, Plug, ScrollText, Settings, Share2, Shield, ShieldOff, ShieldUser, ShoppingCart, SquareMousePointer, Star, Theater, ThumbsUp, TrendingUp, UserCheck, UserCircle, Users, Briefcase as WorkIcon, Zap } from 'lucide-react';
