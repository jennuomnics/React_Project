...
export function Header() {
  ...
  return (
    <header
      className={cn(
        'px-4 header fixed top-0 z-10 start-0 flex items-stretch shrink-0 border-b border-transparent bg-background end-0 pe-[var(--removed-body-scroll-bar-size,0px)]',
